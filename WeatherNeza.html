                       ...
                       <div class="flip-card__inner">
                        <br>
                          ...
                          <div class="flip-card__back">
                             ...
                             <form id="agregaruser" name="agregaruser" class="flip-card__form" action="agregaruser" method="POST">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="value">
                                        Aceptas los <a> terminos de privacidad</a>  </label>
                                  </div>
                                <input type="submit" value="Confirmar" class="flip-card__btn">
                             </form>
